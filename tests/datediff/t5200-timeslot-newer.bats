...
@test "compare --newer timeslot of dates" {
    while IFS=$'\t' read -r datetime1 datetime2 timeslot expectedStatus
    do
	run datediff --newer "$timeslot" "$datetime1" "$datetime2" \
	    && assert_equal $status $expectedStatus \
	    && assert_output '' \
	    || fail "--newer $timeslot ${datetime1@Q} ${datetime2@Q}"

	run datediff --older "$timeslot" "$datetime1" "$datetime2" \
	    && assert_equal $status $((expectedStatus ? 0 : 1)) \
	    && assert_output '' \
	    || fail "--older $timeslot ${datetime1@Q} ${datetime2@Q}"
    done <<-EOF
2026-04-21 12:32:48	2026-04-21 12:32:48	second	0
2026-04-21 12:32:48	2026-04-21 12:32:47	second	1
2026-04-21 12:32:48	2026-04-21 12:32:49	second	0
...
2026-04-21 12:32:48	2026-04-21 12:33:00	minute	0
2026-04-21 12:32:48	2026-04-21 12:33:00	day	0
2026-04-21 12:32:48	2026-04-20 12:33:00	day	1
2026-04-21 12:32:48	2026-04-22 12:33:00	day	0
...
2026-04-21 12:32:48	2026-04-27 10:00:00	week	0
EOF
}
