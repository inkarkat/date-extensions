...
@test "diff with output as original" {
    typeset -A data=(
	[10:00:00]='10:00:00'
	[10:00:01]='10:00:01'
	[10:00:02]='10:00:02'
	...
	[2026-04-20 09:59:59]='2026-04-20 09:59:59'
	[2026-04-19 10:00:00]='2026-04-19 10:00:00'
	[2026-04-21 10:00:00]='2026-04-21 10:00:00'
	[2026-04-21 12:32:48]='2026-04-21 12:32:48'
	[2026-05-12 20:05:00]='2026-05-12 20:05:00'
	[2026-06-01]='2026-06-01'
	[2027-01-01]='2027-01-01'
	[1976-10-20]='1976-10-20'
    )

    for date in "${!data[@]}"
    do
	run -0 datediff --output original '2026-04-20 10:00' "$date" \
	    && assert_output "${data["$date"]}" \
	    || fail "$date"
    done
}
